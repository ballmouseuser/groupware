		...
		<table class="table table-hover">
			<form action="board_modify_view" method="post">
				...
				<tr height="40">
					...
					<input type="button" value="삭제" class="btn btn-default" onClick="location.href='board_delete?board_num=${content_view.board_num}&notice_num=${content_view.notice_num}'"> &nbsp;&nbsp; 
					<%
						}
						if(dto.getNotice_num()==1){
						%>
							<input type="button" value="목록" class="btn btn-default" onClick="location.href='board_list_notice'"> &nbsp;&nbsp;
						<%
						}else{
